            ...
            <div class="responsive__cart-area">
                <form class="cart__form">
                        ...
                        <table width="100%" class="table">
                            ...
                            <tr>
                                <td class="product__thumbnail">
                                    <a href="/detail/${map.value.productsEntity.id}">
                                        <img src='<c:url value="/product/images/${map.value.productsEntity.images}"/>' alt="">
                                    </a>
                                </td>
                                <td class="product__name">
                                    <a href="#">${map.value.productsEntity.nameproduct}</a>
                                    <br><c:out value="${map.value.productsEntity.nameproduct}"/><br>
                                    <small>${map.value.productsEntity.nameproduct}</small>
                                </td>
                                <td class="product__price">
                                    <div class="price">
                                        <span class="new__price">${map.value.productsEntity.price}</span>
                                    </div>
                                </td>
                                ...
                                <td class="product__subtotal">
                                    <div class="price">
                                        <span class="new__price">$${map.value.quantity * map.value.productsEntity.price}</span>
                                    </div>
                                    <a href="/cart/remove/${map.value.productsEntity.id}" class="remove__cart-item">
                                        <svg>
                    ...
                    <div class="cart__totals">
                        ...
                        <a href="/cart/checkoutforms">PROCEED TO CHECKOUT</a>
                    </div>
                </form>
            </div>
        </div>
