...
<form:form method="GET" action="${pageContext.request.contextPath}/cart/Transaction" modelAttribute="ordersEntity">
            ...
            <div class="page slide-page">
                ...
                <div class="field">
                    <div class="label">
                        Full Name</div>
                    <form:input path="transactionname"  value = "${accounts.userEntity.username} "/>
                </div>
                <div class="field">
                    <div class="label">
                        Address</div>
            ...
            <div class="page">
                ...
                <div class="field">
                    <div class="label">
                        Email </div>
                    <form:input path="transactionmail" value = "${accounts.email}" />
                </div>
                <div class="field">
                    <div class="label">
                        Phone Number</div>
                    <form:input path="transactionphone"  value = "${accounts.phonenumber}"/>
                </div>
