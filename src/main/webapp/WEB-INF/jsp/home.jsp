            ...
            <nav class="nav">
                ...
                <div class="nav__menu">
                    <div class="menu__top">
                        ...
                        <a href="/home" class="close__toggle">
                            <svg>
                    ...
                    <ul class="nav__list">
                        <li class="nav__item">
                            <a href="/factory" class="nav__link ">Factory</a>
                        </li>
                ...
                <ul class="glide__slides">
                        ...
                        <div class="hero__center">
                            ...
                            <div class="hero__right">
                                <div class="hero__img-container">
                                    <img class="banner_01" src="/product/images/banner_01.png" alt="banner2" />
                                </div>
                            </div>
                        </div>
                    </li>
                    <li class="glide__slide">
                        <div class="hero__center">
                            ...
                            <div class="hero__right">
                                <img class="banner_02" src="/product/images/banner_02.png" alt="banner2" />
                            </div>
                        </div>
                    </li>
                </ul>
            ...
            <div class="collection__container" data-aos="fade-up" data-aos-duration="1200">
                <div class="collection__box">
                    <div class="img__container">
                        <img class="collection_02" src="/product/images/collection_02.png" alt="">
                    </div>
                ...
                <div class="collection__box">
                    <div class="img__container">
                        <img class="collection_01" src="/product/images/collection_01.png" alt="">
                    </div>
                    <div class="collection__content">
                        <div class="collection__data">
                            ...
                            <li class="glide__slide">
                                <div class="product">
                                    <div class="product__header">
                                        <img id="image" data-image="${s.images}" src='<c:url value="/product/images/${s.images}"/>' alt="product">
                                    </div>
                                    <div class="product__footer">
                                        <h3 id="nameproducts" data-nameproduct="${s.nameproduct}">${s.nameproduct}</h3>
                                        <div class="rating">
                                            <svg>
                                        ...
                                        <div class="product__price">
                                            <h4 id="price" data-price="${s.price}">${s.price}</h4>
                                        </div>
                                        <a href="/cart/addcart/${s.id}"><button data-id="${s.id}" type="submit" class="product__btn btn-addtocart">Add To Cart</button></a>
                                    </div>
                ...
                <div class="glide__track" data-glide-el="track">
                    <ul class="glide__slides">
                        <li class="glide__slide">
                            <div class="testimonial__box">
                                <div class="client__image">
                                    <img src="/product/images/profile1.jpg" alt="profile">
                                </div>
                        ...
                        <li class="glide__slide">
                            <div class="testimonial__box">
                                <div class="client__image">
                                    <img src="/product/images/profile2.jpg" alt="profile">
                                </div>
                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Recusandae fuga hic nesciunt tempore
                        ...
                        <li class="glide__slide">
                            <div class="testimonial__box">
                                <div class="client__image">
                                    <img src="/product/images/profile3.jpg" alt="profile">
                                </div>
                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Recusandae fuga hic nesciunt tempore
                                    quibusdam consequatur
                                    eligendi unde officia ex quae.ipsum dolor sit amet consectetur adipisicing elit. Recusandae fuga hic
                        ...
                        <li class="glide__slide">
                            <div class="testimonial__box">
                                <div class="client__image">
                                    <img src="/product/images/profile4.jpg" alt="">
                                </div>
                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Recusandae fuga hic nesciunt tempore
                                    quibusdam consequatur
                    ...
                    <div class="glide__track" data-glide-el="track">
                        <ul class="glide__slides">
                            <li class="glide__slide">
                                <div class="new__card">
                                    <div class="card__header">
                                        <img src="/product/images/news1.jpg" alt="">
                                    </div>
                            ...
                            <li class="glide__slide">
                                <div class="new__card">
                                    <div class="card__header">
                                        <img src="/product/images/news2.jpg" alt="">
                                    </div>
                                    <div class="card__footer">
                                        <h3>Styling White Shirts After A Cool Day</h3>
                                        <span>By Admin</span>
                            ...
                            <li class="glide__slide">
                                <div class="new__card">
                                    <div class="card__header">
                                        <img src="/product/images/news3.jpg" alt="">
                                    </div>
                                    <div class="card__footer">
                                        <h3>Styling White Shirts After A Cool Day</h3>
                                        <span>By Admin</span>
                            ...
                            <li class="glide__slide">
                                <div class="new__card">
                                    <div class="card__header">
                                        <img src="/product/images/news4.jpg" alt="">
                                    </div>
                                    <div class="card__footer">
                                        <h3>Styling White Shirts After A Cool Day</h3>
                                        <span>By Admin</span>
                            ...
                            <li class="glide__slide">
                                <div class="new__card">
                                    <div class="card__header">
                                        <img src="/product/images/news5.jpg" alt="">
                                    </div>
                                    <div class="card__footer">
                                        <h3>Styling White Shirts After A Cool Day</h3>
                                        <span>By Admin</span>
...
<!--                <img class="popup__img" src="/product/images/popup.jpg" alt="popup">-->
<!--            </div>-->
<!--        </div>-->
...
<!--    </div>-->
<!--</div>-->
<div id="message_box" style="display: none; background: #0f0f0f5c; color: #00bcd4">
    <p id="message_text"></p>
</div>
<!-- Go To -->
