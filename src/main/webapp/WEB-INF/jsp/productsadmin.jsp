    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <!-- end page title -->
                <form:form modelAttribute="pagedListHolder" action="productsadmin">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="/addProducts">   <button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#addcontactmodal">Add </button></a>
                                    ...
                                    <c:forEach var="s" items="${pagedListHolder.pageList}">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="font-13 d-none d-sm-block">${s.productPortfolioEntity.id}</span>
                                            </td>
                                            ...
                                            <td>
                                                    ${s.productPortfolioEntity.portfolio}
                                            </td>
<td>
    ${s.code}
</td>
                                            <td>
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="/editProducts?id=${s.id}"><i class="mdi mdi-pencil mr-1 text-muted"></i>Edit</a>


                                                        <a class="dropdown-item" href="/deleteproduct/${s.id}" id="validate"><i class="mdi mdi-delete mr-1 text-muted"></i>Remove</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <c:url value="/productsadmin" var="pagedLink">
