                ...
                <div class="row my-3">
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mt-3">
                                    <h5 class="mb-2">Hello,${ordersEntity.transactionname}</h5>
                            ...
                            <div class="col-md-6">
                                <div class="mt-3 float-right">
                                    <p class="mb-2"><span class="font-weight-medium">Order Date : </span> <span class="float-right"> &nbsp;&nbsp;&nbsp;&nbsp; ${ordersEntity.transactiondate} </span></p>
                                    <p class="mb-2"><span class="font-weight-medium">Order Status : </span> <span class="float-right"><span class="badge badge-danger">${ordersEntity.transactionstatus}</span></span></p>
                                    <p><span class="font-weight-medium">Order No. : </span> <span class="float-right">${ordersEntity.security} </span></p>
                                </div>
                            </div><!-- end col -->
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                <div class="text-md-right">
                                    ...
                                    <address>
                                        ${ordersEntity.transactionaddress}<br>
                                            ${ordersEntity.transactionmail}<br>
                                            ${ordersEntity.transactionname}<br>
                                        <abbr title="Phone">P:</abbr> ${ordersEntity.transactionphone}
                                    </address>
                                </div>
                            </div> <!-- end col -->
                        </div>
...
<c:forEach var="s" items="${ordersEntities}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="float-right">
                                    <p><span class="font-weight-medium">Sub-total:</span> <span class="float-right">$${ordersEntity.payment}</span></p>
                                    <p><span class="font-weight-medium">Discount (10%):</span> <span class="float-right"> &nbsp;&nbsp;&nbsp; $${ordersEntity.payment * 0.1}</span></p>
                                    <h3>$${ordersEntity.payment + (ordersEntity.payment * 0.1)} USD</h3>
                                </div>
                                <div class="clearfix"></div>
                            </div> <!-- end col -->
                        </div>
