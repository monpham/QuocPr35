    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <form:form modelAttribute="pagedListHolder" action="contacts">
...
<c:forEach var="s"  items="${pagedListHolder.pageList}">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p class="mb-0 font-weight-medium"><a href="javascript: void(0);">${s.email}</a></p>
                                            <span class="font-13 d-none d-sm-block">${s.userEntity.username}</span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="/delete/${s.userEntity.id}" id="validate"><i class="mdi mdi-delete mr-1 text-muted" ></i>Remove</a>
                                                    <a class="dropdown-item" href="/sendmail?email=${s.email}"><i class="mdi mdi-email mr-1 text-muted"></i>Send Email</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <c:url value="/contacts" var="pagedLink">
