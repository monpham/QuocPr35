        ...
        <div class="container">
            <nav class="nav">
                ...
                <div class="nav__icons">
                    ...
                    <a href="/searchproducts" class="icon__item">
                    ...
                    <a href="/cart" class="icon__item">
                        ...
                        <span id="cart__total"><c:out value="${sessionScope.myCartNum == null ? 0 : sessionScope.myCartNum}"/> </span>
                    </a>
                </div>
            </nav>
        </div>
        ...
        <div class="container">
            <div class="page__title-container">
                <ul class="page__titles">
                    ...
                    <li class="page__title">${productsEntity.nameproduct}</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="product-detail__container">
                <div class="product-detail__left">
                    <div class="details__container--left">
                        <div class="product__pictures">
                         <%--   <div class="pictures__container">
                                <img class="picture" src="/product/images/products/iPhone/iphone1.jpeg" id="pic1" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="/product/images/products/iPhone/iphone2.jpeg" id="pic2" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="/product/images/products/iPhone/iphone3.jpeg" id="pic3" />
                            </div>
                            <div class="pictures__container">
                                <img class="picture" src="/product/images/products/iPhone/iphone4.jpeg" id="pic4" />
                            </div>--%>
                      <%--      <div class="pictures__container">
                                <img class="picture" src="/product/images/products/iPhone/iphone5.jpeg" id="pic5" />
                            </div>--%>
                        </div>
                        <div class="product__picture" id="product__picture">
                            <!-- <div class="rect" id="rect"></div> -->
                            <div class="picture__container">
                                <img src='<c:url value="/product/images/${productsEntity.images}"/>' id="pic" />
                            </div>
                        </div>
                    ...
                    <div class="product-details__btn">
                        <a class="add" href="/cart/addcart/${productsEntity.id}">
                <span>
                  <svg>
                    <use xlink:href="/product/images/sprite.svg#icon-cart-plus"></use>
                  </svg>
                </span>
                            ADD TO CART</a>
                        <a class="buy" href="#">
                ...
                <div class="product-detail__right">
                    <div class="product-detail__content">
                        <h3>${productsEntity.nameproduct}</h3>
                        <div class="price">
                            <span class="new__price">$${productsEntity.price}</span>
                        </div>
                        <div class="product__review">
                            <div class="rating">
                                <svg>
                                    <use xlink:href="/product/images/sprite.svg#icon-star-full"></use>
                                </svg>
                                <svg>
                                    <use xlink:href="/product/images/sprite.svg#icon-star-full"></use>
                                </svg>
                                ...
                                <svg>
                                    <use xlink:href="/product/images/sprite.svg#icon-star-empty"></use>
                                </svg>
                            </div>
                    ...
                    <span>
                      <svg>
                        <use xlink:href="/product/images/sprite.svg#icon-crop"></use>
                      </svg>
                    </span>&nbsp;
                                    SIZE GUIDE
                                </a>
                    ...
                    <span>
                      <svg>
                        <use xlink:href="/product/images/sprite.svg#icon-truck"></use>
                      </svg>
                    </span>&nbsp;
                                    SHIPPING
                                </a>
                    ...
                    <span>
                      <svg>
                        <use xlink:href="/product/images/sprite.svg#icon-envelope-o"></use>
                      </svg>&nbsp;
                    </span>
      ...
      <!-- Related Products -->
        <section class="section related__products">
            <div class="title__container">
                <div class="section__title filter-btn active">
                    <span class=" dot"></span>
                    <h1 class="primary__title">Iphone Products</h1>
                </div>
            </div>
                ...
                <div class="glide" id="glide_3">
                    <div class="glide__track" data-glide-el="track">
                        <ul class="glide__slides latest-center">
                            <c:forEach var="s" items="${ProductList1}">
                            <li class="glide__slide">
                                <div class="product">
                                    <div class="product__header">
                                        <a href="#"><img src='<c:url value="/product/images/${s.images}"/>' alt="product"></a>
                                    </div>
                                    <div class="product__footer">
                                        <h3>${s.nameproduct}</h3>
                                        <div class="rating">
                                            <svg>
                                                <use href="/product/images/sprite.svg#icon-star-full"></use>
                                            </svg>
                                            <svg>
                                                <use xlink:href="/product/images/sprite.svg#icon-star-full"></use>
                                            </svg>
                                        ...
                                        <a href="/cart/addcart/${s.id}"><button type="submit" class="product__btn">Add To Cart</button></a>
                                    </div>
                                    <ul>
                                        <li>
                                            <a data-tip="Quick View" data-place="left" href="/detail/${s.id}">
                                                <svg>
                                                    <use xlink:href="/product/images/sprite.svg#icon-eye"></use>
                                                </svg>
                                            </a>
                                        </li>
                                        <li>
                                            <a data-tip="Add To Wishlist" data-place="left" href="#">
                                                <svg>
                                                    <use xlink:href="/product/images/sprite.svg#icon-heart-o"></use>
                                                </svg>
                                            </a>
                                        </li>
                                        <li>
                                            <a data-tip="Add To Compare" data-place="left" href="#">
                                                <svg>
                                                    <use xlink:href="/product/images/sprite.svg#icon-loop2"></use>
                                                </svg>
                                            </a>
                                        </li>
                                    </ul>
                    ...
                    <div class="glide__arrows" data-glide-el="controls">
                        <button class="glide__arrow glide__arrow--left" data-glide-dir="<">
                            <svg>
                                <use xlink:href="/product/images/sprite.svg#icon-arrow-left2"></use>
                            </svg>
                        </button>
                        <button class="glide__arrow glide__arrow--right" data-glide-dir=">">
                            <svg>
                                <use xlink:href="/product/images/sprite.svg#icon-arrow-right2"></use>
                            </svg>
                        </button>
                    </div>
                </div>
        ...
        <section class="section latest__products">
            <div class="title__container">
                <div class="section__title filter-btn active" data-id="Latest Products">
                    <span class="dot"></span>
                    <h1 class="primary__title">Ipad Products</h1>
                </div>
            </div>
            <div class="container" data-aos="fade-up" data-aos-duration="1200">
                <div class="glide" id="glide_2">
                    <div class="glide__track" data-glide-el="track">
                        <ul class="glide__slides latest-center">
                            <c:forEach var="s" items="${ProductList2}">
                            <li class="glide__slide">
                                <div class="product">
                                    <div class="product__header">
                                        <a href="#"><img src='<c:url value="/product/images/${s.images}"/>'  alt="product"></a>
        ...
        <section class="section latest__products">
            <div class="title__container">
                <div class="section__title filter-btn active" data-id="Latest Products">
                    <span class="dot"></span>
                    <h1 class="primary__title">Macbook Products</h1>
                </div>
            </div>
            ...
            <div class="container" data-aos="fade-up" data-aos-duration="1200">
                <div class="glide" id="glide_4">
                    <div class="glide__track" data-glide-el="track">
                        <ul class="glide__slides latest-center">
                            <c:forEach var="s" items="${ProductList3}">
                            <li class="glide__slide">
                                <div class="product">
                                    <div class="product__header">
                                        <a href="#"><img src='<c:url value="/product/images/${s.images}"/>'  alt="product"></a>
       ...
       <section class="section latest__products">
            <div class="title__container">
                <div class="section__title filter-btn active" data-id="Latest Products">
                    <span class="dot"></span>
                    <h1 class="primary__title">Headphone Products</h1>
                </div>
            </div>
            <div class="container" data-aos="fade-up" data-aos-duration="1200">
                <div class="glide" id="glide_5">
                    <div class="glide__track" data-glide-el="track">
                        <ul class="glide__slides latest-center">
                            <c:forEach var="s" items="${ProductList4}">
                            <li class="glide__slide">
                                <div class="product">
                                    <div class="product__header">
                                        <a href="#"><img src='<c:url value="/product/images/${s.images}"/>'  alt="product"></a>
