...
public ProductsEntity editProducts(int id);
 ...
 Page<ProductsEntity> getAll(int pageNumber);

 Page<ProductsEntity> getPaginatedArticles(Pageable pageable);
 //
 Page<ProductsEntity> find(String name, Pageable pageable);
 Page<ProductsEntity> getAll(int pageNumber, String sortField, String sortDir);
